...
@Controller public class HomeController {
    ...
    @GetMapping("/") public String getHomePage(@RequestParam(defaultValue = "GENERAL KANOBI", required=false)@PathVariable String user, Model m){
        m.addAttribute("user", user);
        return "home";
    }

    @GetMapping("/helloworld/{input}") public String getCap(@RequestParam(defaultValue = "no cap", required=false)@PathVariable String input, Model m){
        m.addAttribute("capital", input);
        return "helloworld";
    }
